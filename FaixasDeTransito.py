...
class FaixasDeTransito:
    ...
    def calcular_offset(self, img, pontos, debug=False):
        ...
        if ponto_esquerda != 0 and ponto_direita != 0:
            ...
            if debug:
                print('\nCP:', centro_pista, '|', 'offset:', offset, '|', 'XFD:', ponto_direita, '|', 'XFE:', ponto_esquerda)
            ...
            if debug:
                print('\nCP:', centro_pista, '|', 'offset:', offset, '|', 'dist_max:', self.dist_max_entre_faixas, '|', 'CI:', posicao_carro, '|', 'XFD:', ponto_direita, '|', 'XFE:', ponto_esquerda)
